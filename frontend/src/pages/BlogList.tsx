...
export const BlogList = () => {
  ...
  useSEO({
    ...
    description: "Conte˙dos exclusivos, tendÍncias e estratÈgias para manter seu negÛcio sempre ‡ frente no mundo digital",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              Conte√∫dos exclusivos, tend√™ncias e estrat√©gias para manter seu neg√≥cio sempre √† frente no mundo digital
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {posts.length === 0 && !loading ? (
                <p>Nenhum post dispon√≠vel no momento</p>
              ) : (
